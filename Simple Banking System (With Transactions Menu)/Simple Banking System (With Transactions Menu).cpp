...
/*
 ...
 3. Choose an option by entering the corresponding number (1 to 7).
 ...
 9. **To perform a transaction** (Deposit or Withdraw), select option 6. The following options will appear:
	- [1] Deposit - Deposit money into a client's account by entering the account number and the deposit amount.
	- [2] Withdraw - Withdraw money from a client's account. Ensure the amount is less than or equal to the account balance.
	- [3] Show Total Balances - Display the total balance of all clients' accounts.
	- [4] Main Menu - Return to the main menu.
 10. To exit the program, select option 7.
